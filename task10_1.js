 ...
 *
 * @param {Array<Object>} qaList - An array of Q&A objects, each with 'title' and 'content' properties.
 ...
 */
function searchQnA(qaList, keywords) {
  // Input validation: Check if qaList is an array and keywords is an array of strings
  if (
...
console.log(searchQnA(sampleQAList, ["return", "shipping", "password"]));
/* Expected output
[
  {
    title: 'How to change my password?',
...
console.log(searchQnA(sampleQAList, ["shipping"]));
/* Expected output
[
  {
    title: 'Shipping Information',
...
console.log(searchQnA(sampleQAList, ["damaged", "paypal"]));
/*Expected output
[
  {
    title: 'Return Policy',
...
console.log(searchQnA(sampleQAList, [])); // Expected Output: [] (No keywords provided)

console.log(searchQnA([], ["password"])); // Expected Output: [] (Empty qas array)
